  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'StoreName', label: 'Store', field: 'StoreName', align: 'left' },
        { name: 'RequestedPrice', label: 'Original Price', field: 'RequestedPrice', align: 'left' },
        { name: 'FinalPrice', label: 'Paid Price', field: 'FinalPrice', align: 'left' },
        { name: 'StartDate', label: 'Date', field: 'StartDate', align: 'left' },
